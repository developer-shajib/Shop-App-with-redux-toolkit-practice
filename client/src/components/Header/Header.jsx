import lan1 from '../../assets/images/flags/eng.png';
import lan3 from '../../assets/images/flags/fra.png';
import p1 from '../../assets/images/cart/product-1.jpg';
        ...
        <div className='header-top'>
          <div className='container'>
            ...
            <div className='header-right'>
              ...
              <div className='dropdown'>
                <a href='#language'>
                  <img src={lan1} alt='ENG Flag' width='14' height='8' className='dropdown-image' /> ENG
                </a>
                <div className='dropdown-box'>
                  <a href='#ENG'>
                    <img src={lan1} alt='ENG Flag' width='14' height='8' className='dropdown-image' />
                    ENG
                  </a>
                  <a href='#FRA'>
                    <img src={lan3} alt='FRA Flag' width='14' height='8' className='dropdown-image' />
                    FRA
                  </a>
                </div>
              </div>
                    ...
                    <div className='product product-cart'>
                      ...
                      <figure className='product-media'>
                        <a href='product-default.html'>
                          <img src={p1} alt='product' height='84' width='94' />
                        </a>
                      </figure>
              ...
              <div className='header-left'>
                ...
                <nav className='main-nav'>
                  <ul className='menu active-underline'>
                    ...
                    <li>
                      <NavLink to='/wishlist'>Pages</NavLink>
                      <ul>
                        <li>
