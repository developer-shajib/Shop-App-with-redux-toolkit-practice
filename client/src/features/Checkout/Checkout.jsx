          ...
          <div className='page-content'>
            <div className='container'>
              ...
              <form className='login-content'>
                <p>
                  If you have shopped with us before, please enter your details below. If you are a new customer, please
                  proceed to the Billing section.
                </p>
                <div className='row'>
                ...
                <div className='row mb-9'>
                  <div className='col-lg-7 pr-lg-4 mb-4'>
                    ...
                    <div className='form-group checkbox-toggle pb-2'>
                      <input type='checkbox' className='custom-checkbox' id='shipping-toggle' name='shipping-toggle' />
                      ...
                      <div className='row gutter-sm'>
                        <div className='col-md-6'>
                          ...
                          <div className='form-group'>
                            ...
                            <input type='text' className='form-control form-control-md' name='postcode' required />
                          </div>
                        </div>
                        <div className='col-md-6'>
                          <div className='form-group'>
                          ...
                          <tfoot>
                            <tr className='shipping-methods'>
                              <td colSpan='2' className='text-left'>
                                <h4 className='title title-simple bb-no mb-1 pb-0 pt-3'>Shipping</h4>
